      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" class="user" method="POST" action="<?= base_url('auth/registrasi')?>">
                <div class="mb-3">
                  <input type="text" class="form-control" value="<?= set_value('nama');?>" name="nama" id="nama" placeholder="Name" aria-label="Name">
                  <?=form_error('nama','<small class="text-danger pl-3"></small>');?>
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" value="<?= set_value('email');?>" name="email" id="email" placeholder="Email" aria-label="Email">
                  <?=form_error('email','<small class="text-danger pl-3"></small>');?>
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" value="<?= set_value('password1');?>" name="password1" id="password1" placeholder="Password" aria-label="Password">
                  <?=form_error('password1','<small class="text-danger pl-3"></small>');?>
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" value="<?= set_value('password2');?>" name="password2" id="password2" placeholder="Password" aria-label="Password">
                ...
                <div class="text-center">
                  <button type="submit" name="tambah" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                </div>
